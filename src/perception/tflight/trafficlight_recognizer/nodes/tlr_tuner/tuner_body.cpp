...
void TunerBody::saveResult(std::string fileName)
{
  ...
  /* write data to file */
  {
    cv::internal::WriteStructContext st_red(cvfs, "RED", cv::FileNode::SEQ+cv::FileNode::FLOW);
    // cv::internal::WriteStructContext st_red(cvfs, "RED", cv::FileNode::SEQ+cv::FileNode::FLOW);
    {
      cv::internal::WriteStructContext st_hue(cvfs, "Hue", cv::FileNode::SEQ+cv::FileNode::FLOW);
      // cv::internal::WriteStructContext st_hue(cvfs, "Hue", cv::FileNode::SEQ+cv::FileNode::FLOW);
    ...
    {
      cv::internal::WriteStructContext st_hue(cvfs, "Saturation", cv::FileNode::SEQ+cv::FileNode::FLOW);
      cv::write(cvfs, "center", Red_set.sat.center);
      cv::write(cvfs, "range", Red_set.sat.range);
    }

    {
      cv::internal::WriteStructContext st_hue(cvfs, "Value", cv::FileNode::SEQ+cv::FileNode::FLOW);
  ...
  {
    cv::internal::WriteStructContext st_yellow(cvfs, "YELLOW", cv::FileNode::SEQ+cv::FileNode::FLOW);
    // cv::internal::WriteStructContext st_yellow(cvfs, "YELLOW", cv::FileNode::SEQ+cv::FileNode::FLOW);
    {
      cv::internal::WriteStructContext st_hue(cvfs, "Hue", cv::FileNode::SEQ+cv::FileNode::FLOW);
      // cv::internal::WriteStructContext st_hue(cvfs, "Hue", cv::FileNode::SEQ+cv::FileNode::FLOW);
  ...
  {
    cv::internal::WriteStructContext st_green(cvfs, "GREEN", cv::FileNode::SEQ+cv::FileNode::FLOW);
    {
      cv::internal::WriteStructContext st_hue(cvfs, "Hue", cv::FileNode::SEQ+cv::FileNode::FLOW);
...
void TunerBody::openSetting(std::string fileName)
{
  ...
  /* read data from file */
  cv::FileNode topNode = cvfs["images"];
  {
