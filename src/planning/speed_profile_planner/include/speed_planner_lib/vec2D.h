...
template <class T> T cross(const Vector2d<T> &a, const Vector2d<T> &b) {
...
template <class T>
Vector2d<T>
Vector2d<T>::get_Intersect(const Vector2d<T> &aa, const Vector2d<T> &ab,
                           const Vector2d<T> &ba, const Vector2d<T> &bb) {
...
template <class T> void Vector2d<T>::rotate(float angle_degrees) {
...
template <class T> Vector2d<T> Vector2d<T>::rotated(float angle_degrees) {
