...
public:
  ...
  void setCurrentWaypoints(const std::vector<casper_auto_msgs::Waypoint>& wps)
  {
  ...
  std::vector<casper_auto_msgs::Waypoint> getCurrentWaypoints() const
  {
...
private:
  ...
  std::vector<casper_auto_msgs::Waypoint> current_waypoints_{};
